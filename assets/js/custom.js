...
//  Slider Login Form
        ...
        $("#slider-form").validate({
            submitHandler: function() {
                $.post("slider-form.php", $("#slider-form").serialize(),  function(response) {
					if(response==1){
					$('#form-status').html('<span id="invalid">Invalid Email Address of password. <h4><a style="color:red" href="register-sign-in.php">sign up?</a></h4></span>');}
					else
					{
    ...
    $("#submit").bind("click", function(event){
        $("#form").validate({
            submitHandler: function() {
                $.post("slider-form.php", $("#form").serialize(),  function(response) {
					if(response==1){
					$('#form-status').html('<span id="invalid">Invalid Email Address of password. <h4><a style="color:red" href="register-sign-in.php">sign up?</a></h4></span>');}
					else
					{
	    ...
	    $("#submit-form-register").bind("click", function(event){
        $("#submit-registeration").validate({
            submitHandler: function() {
                $.post("sign_up-form.php", $("#submit-registeration").serialize(),  function(response) {
					if(response==1){
					$('#form-status_re').html('<span id="invalid">Password is not match</span>');}
					if(response==1){
					$('#form-status_re').html('<span id="invalid">Email Address</span>');}
					else
					{
							//$('#form-status').html(response);
